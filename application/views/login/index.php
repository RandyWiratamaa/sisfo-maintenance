...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/web/css/lib/animate.min.css">
</head>
<body class="main-bg">
    ...
    <h3 class="text-whitesmoke">Sign In</h3>
      <div class="container-content">
           <?php 
                ...
                // form open login
                echo form_open(base_url('login/pegawai'));
              ?>
          <div class="form-group">
              <input type="text" class="form-control" name="id" placeholder="NIK Pegawai">
          </div>
          <div class="form-group">
          ...
          <a class="text-darkyellow" href="<?php echo base_url('login/forgotPassword') ?>"><small>Forgot your password?</small></a>
          <p class="text-whitesmoke text-center"><small>Do not have an account?</small></p>
          <a class="text-darkyellow" href="<?php echo base_url('registrasi') ?>"><small>Sign Up</small></a>
        <?php echo form_close(); ?> 
      </div>
  </div>
</body>
